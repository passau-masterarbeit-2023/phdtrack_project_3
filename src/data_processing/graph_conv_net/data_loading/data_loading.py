...
def load_no_annotated_graph(no_annotated_graph_dot_gv_file_path: str):
    """
    Load non-annotated graph from given path.
    Return a DOT graph using graphviz library.
    """

    # Read the file
    with open(no_annotated_graph_dot_gv_file_path, 'r') as f:
        dot_graph = f.read()
