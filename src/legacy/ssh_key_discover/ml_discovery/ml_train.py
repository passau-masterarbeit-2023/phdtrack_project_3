...
def train_rfc(
    ...
    with time_measure('fit_rfc_classifier', params.RESULTS_LOGGER):
...
def train_high_recall_classifier(
    ...
    with time_measure('fit_grid_search_classifier', params.RESULTS_LOGGER):
        grid_search.fit(samples, labels)

    # print the best parameters
    params.RESULTS_LOGGER.info("Best parameters: ", grid_search.best_params_)
